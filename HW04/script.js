...
// заданным ID с удаленного сервера. Функция должна возвращать promise,
...
// Если запрос успешен (с кодом 200),
...
// */
// const url = `https://site.com/users`;

// const getUserData = async (userId) => {
//   const urlFetch = url + `/${userId}`;
...
//  в качестве аргумента и использует fetch для отправки этих данных на удаленный
//  сервер для сохранения. Функция должна возвращать промис, который разрешается,
